      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-10">
          <Image 
            ...
            height={600} 
            priority 
            className="w-full h-auto drop-shadow-[0_0_40px_rgba(255,215,0,.25)]"
          />
        </div>
        ...
        {/* ENTER DASHBOARD = 1 BUTTON ONLY */}
        <Link 
          href="/dashboard" 
          className="mt-10 block w-full rounded-full bg-gradient-to-r from-[#FFD700] to-[#00D9FF] py-4 text-center text-base font-bold text-black"
        >
          Enter Dashboard →
        </Link>
      </div>
